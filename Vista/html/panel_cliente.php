...
<body>
                    ...
                    <div class="row wow fadeIn">
                        <div class="col-md-12">
                            ...
                            <div class="product-wrapper">
                                <!--Product data-->
                                <div class="mt-4"> <button class="btn btn-cyan" data-toggle="modal" data-target="#frmRegistrarCliente"><i class="fa fa-plus mr-1"></i> Cliente</button> </div>
                                <hr>
                                <table id="MostrarClientes" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>CC</th>
                                            <th>Nombre</th>
                                            <th>Apellido</th>
                                            <th>Fe de Nacimiento</th>
                                            <th>Direccion</th>
    ...
    <?php 
        require "Vista/html/modal_editar_cliente.php";
        require "Vista/html/modal_registrar_cliente.php";
    ?>
    <!-- /Start your project here-->
    <!-- SCRIPTS -->
    ...
    <script type="text/javascript" src="Vista/js/cli.js"></script>
</body>
</html>